...
Клиенты могут статически получить IP в своей подсети своего VLAN и отвечают друг другу на пинг. STP работает, в качестве корня всех VLAN настроен L3 за счёт предустановки приоритетов.
